...
# ---------------------------------------------------------------------
# Email (SMTP - Real Email Sending)
# ---------------------------------------------------------------------
# NOTE:
# Currently emails will print in terminal because of console backend above.
# If you want real emails to reach inbox, comment console backend and uncomment below.
